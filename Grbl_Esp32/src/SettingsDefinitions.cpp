...
void make_settings() {
    ...
    sj_cfg_y_mate_dist  = new FloatSetting(GRBL, WG, NULL, "SJConfig/MateDist", -47,-100,100);
    sj_cfg_x_pulloff_dist  = new FloatSetting(GRBL, WG, NULL, "SJConfig/XPulloffDist", 150,0,330); 
}
